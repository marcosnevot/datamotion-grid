...
export function SidePanel({ selectedRowInfo }: SidePanelProps) {
  return (
    <div className="flex h-full flex-col gap-4 px-4 py-4 text-sm text-slate-200">
      <div>
      ...
      >
        ...
        <ul className="mt-1 space-y-1 text-xs text-slate-500">
          ...
          <li>
            <span className="font-mono text-slate-300">Alt + C</span> Toggle
            column panel
          </li>
          <li>
            <span className="font-mono text-slate-300">Alt + 1 / 2 / 3</span>{' '}
            Apply preset views
          </li>
        </ul>
